...
public class RestorePremiumIndicatorService extends RestoreAnalyticsStateService<PremiumKey,
        ...
        PremiumIndicator
        > {
    public RestorePremiumIndicatorService(ReadAnalyticsStatePort<IndicatorPriceDataKey<PremiumKey>, RecoveryIndicatorState> reader, MappingRecoverToStatePort<RecoveryIndicatorState, PremiumKey, PremiumIndicator> mapper, AnalyticsMangerController<?, ?, PremiumIndicator, ?> core) {
