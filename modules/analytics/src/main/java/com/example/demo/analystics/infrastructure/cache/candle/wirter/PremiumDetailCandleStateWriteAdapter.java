...
@Repository
public class PremiumDetailCandleStateWriteAdapter extends CandleStateWriteAdapter<
        PremiumDetailCandle, PremiumKey, PremiumDetailValue> {


    public PremiumDetailCandleStateWriteAdapter(RedisTemplate<String, String> redis, CandleStateCodec<PremiumDetailCandle, PremiumDetailValue> stateCodec, DataKeyCodec<PremiumKey> keyCodec, CacheExpirationPolicy policy, CandleRedisKeyGenerator keyGenerator) {
