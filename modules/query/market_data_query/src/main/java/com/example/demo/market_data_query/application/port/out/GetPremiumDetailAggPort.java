...
public interface GetPremiumDetailAggPort {
    ...
    List<PremiumTimeSeriesView> findAgg(Long baseExchangeId, Long compareExchangeId, String symbol,
                                        int bucketSeconds, Long fromTs, Long toTs);

    List<PremiumTimeSeriesView> findAggCursor(Long baseExchangeId, Long compareExchangeId, String symbol,
