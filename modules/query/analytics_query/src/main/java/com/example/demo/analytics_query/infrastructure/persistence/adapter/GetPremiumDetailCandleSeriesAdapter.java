...
public class GetPremiumDetailCandleSeriesAdapter implements GetPremiumDetailCandleSeriesPort {

    private final PremiumDetailCandleJpaRepository repo;
    private final PremiumDetailCandleViewMapper mapper;

    @Override
    public List<PremiumDetailCandleView> findSeries(String symbol, Long baseExchangeId, Long compareExchangeId, String interval, long fromTs, long toTs) {
