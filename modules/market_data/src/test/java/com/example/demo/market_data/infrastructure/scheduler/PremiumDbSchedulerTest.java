...
class PremiumDbSchedulerTest {

    @Mock FlushPriceValueBufferUseCase.ForPremium useCase;

    @Test
    @DisplayName("process() 호출 시 ForPremium.flush() 1회 위임")
    void process_delegatesToUseCaseFlush() {
        // given
        PremiumDbScheduler sut = new PremiumDbScheduler(useCase);
